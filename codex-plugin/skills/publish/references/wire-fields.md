...
| `shortUrl` | every board object (create, list, get) (`boardJSON` in `internal/web/handlers_boards.go`) | ShortURL is the terminal-safe /b/{id} redirect form of URL — short enough to never soft-wrap (wrapped URLs lose clickability in terminals). |
